...
- test the normality of the distributions you're working with
```{r}

#cannot test normality until you explain what a normal curve is
normals <- ba_and_ma %>%
...
pairwise.wilcox.test(ba_and_ma$Income, ba_and_ma$SchoolDegree,
                 p.adjust.method = "BH")
```
