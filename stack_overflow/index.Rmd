...
In this lesson we use the [Stack Exchange API](https://api.stackexchange.com/docs) to get data from Stack Overflow. We use [this query](https://data.stackexchange.com/stackoverflow/query/59301/questions-per-month-top-10-tags-compared) to get a **.csv file** that pulls data from Stack Overflow. We can actually download that file to our local machine and work with the data from there. 
