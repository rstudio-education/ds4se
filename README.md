...
-   Are there differences between projects that use different languages?
    ...
    -   And once we have a way to classify projects, what kinds of statistical tests will tell us if two populations are the same or different? Beyond *what* tests, how do we interpet the results correctly (especially without making errors about what the results are actually saying!)
