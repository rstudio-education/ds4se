...
## Which Language Uses More Lines per Function?
```{r fig.align='center',message=FALSE}
data <- data %>%
  group_by(Language) %>%
  mutate(line_per_func = Lines/(FunctionDefs))


plt = ggplot(data,aes(line_per_func,fill=Language))+
